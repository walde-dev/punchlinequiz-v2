...
import { getSeoArtistsFn } from "../lib/artist"
...
export const Route = createFileRoute("/artists")({
  ...
  head: () =>
    seo({
      title: "Alle Artists",
      description:
        "Alle Künstler im punchlinequiz — spiel das Punchline-Quiz für jeden Artist im deutschen Rap.",
      path: "/artists",
    }),
})
      ...
      <main className="relative mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 px-5 pt-20 pb-12 md:px-8">
        ...
        >
          <span className="text-[10px] font-bold tracking-[0.22em] text-primary/80 uppercase">
            {t("artistsHub.eyebrow")}
          </span>
          <h1 className="text-3xl font-extrabold tracking-tight">
            {t("artistsHub.title")}
          </h1>
          <p className="text-sm text-muted-foreground">
            {t("artistsHub.subtitle", { count: artists.length })}
          </p>
        </header>
